...
export default function Dashboard() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Nunito:wght@400;500;600;700;800;900&family=Syne:wght@400;700;800&display=swap');
        * { box-sizing: border-box; margin:0; padding:0; }
        ...
        .level-tab { flex:1; padding:13px 8px; cursor:pointer; border:none; background:transparent; font-family:'Nunito',sans-serif; font-size:0.85rem; font-weight:600; color:#5a5a72; border-radius:10px; transition:all 0.2s; text-align:center; }
